...
| P5 | App setting `BONFIRE_PACKAGE_SHA = data.archive_file.function.output_sha256` forces a redeploy whenever the zip content changes; `zip_deploy_file` alone does not detect content changes. | controller |
