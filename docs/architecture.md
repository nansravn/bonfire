...
- **Adapter** (a directory under `games/<name>/`: compose file, `adapter.sh`, `adapter.json`). Owns: everything game-specific.
<!-- TODO-LINK: contracts/adapter-interface.md -->
Depends on: Docker and the data disk. Contract in contracts/adapter-interface.md.
