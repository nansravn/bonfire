...
| ADR | Title | Status |
|---|---|---|
| [0001](0001-compute-vm-plus-docker.md) | Compute: a single VM running Docker | Accepted, amended 2026-09-12 |
...
| [0008](0008-function-ack-then-queue.md) | The Function acknowledges over HTTP and does its work from a queue | Accepted, amended 2026-09-12 |
